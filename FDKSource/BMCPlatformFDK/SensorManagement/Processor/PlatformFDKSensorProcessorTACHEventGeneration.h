/** 
  * @file BMCFWSensorProcessorTACHEventGeneration.h
  * @brief  BMC Firmware Sensor Processor TACH Event Generation Information 
  * @version 1.0 
  * @date 2022
  * @author 	
  */
 ...
 #ifndef __FREEBMCFWSENSORPROCESSORTACHEVENTGENERATION_H__
 #define __FREEBMCFWSENSORPROCESSORTACHEVENTGENERATION_H__
 
 BMCFirmwareSensorThresholdEventGeneration_sT BMCFirmwareSensorThresholdEventGeneration[] = {
    ...
    */
    ...
    { 
        PROCESSOR_TACH_SENSOR_NUMBER_0, 
        {
            {   // Upper Non Recoverable Going High 
                ...
                BMCFW_PLATFORM_CPU_0_COMPONENT_ID_FAN,                  // Event Source
    ...
    { 
        ...
        {   // Upper Non Recoverable Going High 
            ...
            (A_SEL | A_PC | A_PD | A_AFB | A_FLS | A_MAN | A_AUTO), // Assertion
            (A_SEL | A_PC | A_PD | A_AFB | A_FLS | A_MAN | A_AUTO), // DeAssertion
            BMCFW_PLATFORM_CPU_1_COMPONENT_ID_FAN,                  // Event Source
            BMCFW_FW_SENSOR_MONITORING_COMPONENT_ID,                // Firmware Source
        },
 ...
 #endif /* __BMCFWSENSORPROCESSORTACHEVENTGENERATION_H__ */
