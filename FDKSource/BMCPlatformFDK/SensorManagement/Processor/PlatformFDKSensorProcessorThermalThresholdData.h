/** 
  * @file BMCFWSensorProcessorThermalThresholdData.h
  * @brief  BMC Firmware Sensor Thresholds Information 
  * @version 1.0 
  * @date 2022
  * @author 	
  */
 ...
 #ifndef __BMCFWSENSORPROCESSORTHERMALTHRESHOLDDATA_H__
 #define __BMCFWSENSORPROCESSORTHERMALTHRESHOLDDATA_H__
 
 BMCFirmwareSensorThresholds_sT BMCFirmwareSensorProcessorThermalThresholds[] = {
...
#endif /* __BMCFWSENSORPROCESSORTHERMALTHRESHOLDDATA_H__*/