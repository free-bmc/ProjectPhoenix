/** 
  * @file BMCFWSensorProcessorThermalEventGeneration.h
  * @brief  BMC Firmware Sensor Processor Thermal Event Generation Information 
  * @version 1.0 
  * @date 2022
  * @author 	
  */
 ...
 #ifndef __BMCFWSENSORPROCESSORTHERMALEVENTGENERATION_H__
 #define __BMCFWSENSORPROCESSORTHERMALEVENTGENERATION_H__
 
 BMCFirmwareSensorThresholdEventGeneration_sT BMCFirmwareSensorProcessorThermalThresholdEventGeneration[] = {
    ...
    { 
        PROCESSOR_THERMAL_SENSOR_NUMBER_0, 
        {
            {   // Upper Non Recoverable Going High 
                ...
                BMCFW_PLATFORM_CPU_0_COMPONENT_ID_THERMAL_SENSOR,       // Event Source
    ...
    { 
        ...
        {   // Upper Non Recoverable Going High 
            ...
            (A_SEL | A_PC | A_PD | A_AFB | A_FLS | A_MAN | A_AUTO), // Assertion
            (A_SEL | A_PC | A_PD | A_AFB | A_FLS | A_MAN | A_AUTO), // DeAssertion
            BMCFW_PLATFORM_CPU_1_COMPONENT_ID_THERMAL_SENSOR,       // Event Source
            BMCFW_FW_SENSOR_MONITORING_COMPONENT_ID,                // Firmware Source
        },
 ...
 #endif /* __BMCFWSENSORPROCESSORTHERMALEVENTGENERATION_H__ */
