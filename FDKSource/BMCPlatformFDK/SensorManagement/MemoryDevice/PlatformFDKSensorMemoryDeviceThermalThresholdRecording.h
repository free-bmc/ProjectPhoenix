/** 
  * @file BMCFWSensorMemoryDeviceThermalThresholdRecording.h
  * @brief  BMC Firmware Sensor Memory Device Thermal Thresholds Recording Information 
  * @version 1.0 
  * @date 2022
  * @author 	
  */
 ...
 #ifndef __BMCFWSENSORMEMORYDEVICETHERMALTHRESHOLDRECORDING_H__
 #define __BMCFWSENSORMEMORYDEVICETHERMALTHRESHOLDRECORDING_H__
    ...
    BMCFirmwareSensorThresholdRecording_sT BMCFirmwareSensorMemoryDeviceThermalThresholdRecording[] = {
...
#endif /* __BMCFWSENSORMEMORYDEVICETHERMALTHRESHOLDRECORDING_H__ */