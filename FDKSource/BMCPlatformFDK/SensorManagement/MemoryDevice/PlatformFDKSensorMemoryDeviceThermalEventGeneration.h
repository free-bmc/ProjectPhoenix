/** 
  * @file BMCFWSensorMemoryDeviceThermalEventGeneration.h
  * @brief  BMC Firmware Sensor Memory Device Thermal Event Generation Information 
  * @version 1.0 
  * @date 2022
  * @author 	
  */
 ...
 #ifndef __BMCFWSENSORMEMORYDEVICETHERMALEVENTGENERATION_H__
 #define __BMCFWSENSORMEMORYDEVICETHERMALEVENTGENERATION_H__
 
 BMCFirmwareSensorThresholdEventGeneration_sT BMCFirmwareSensorMemoryDeviceThermalThresholdEventGeneration[] = {
    ...
    { 
        MEMORY_THERMAL_SENSOR_NUMBER_0, 
        {
            {   // Upper Non Recoverable Going High 
                ...
                BMCFW_PLATFORM_DIMM_0_COMPONENT_ID_THERMAL_SENSOR,      // Event Source
    ...
    { 
        MEMORY_THERMAL_SENSOR_NUMBER_1, 
        {
            {   // Upper Non Recoverable Going High 
                ...
                (A_SEL | A_PC | A_PD | A_AFB | A_FLS | A_MAN | A_AUTO), // Assertion
                (A_SEL | A_PC | A_PD | A_AFB | A_FLS | A_MAN | A_AUTO), // DeAssertion
                BMCFW_PLATFORM_DIMM_1_COMPONENT_ID_THERMAL_SENSOR,      // Event Source
                BMCFW_FW_SENSOR_MONITORING_COMPONENT_ID,                // Firmware Source
            },
 ...
 #endif /* __BMCFWSENSORMEMORYDEVICETHERMALEVENTGENERATION_H__ */
