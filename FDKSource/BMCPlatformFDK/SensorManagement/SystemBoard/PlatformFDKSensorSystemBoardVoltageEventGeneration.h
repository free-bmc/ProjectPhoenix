/** 
  * @file BMCFWSensorSystemBoardVoltageEventGeneration.h
  * @brief  BMC Firmware Sensor System Board Voltage Event Generation Information 
  * @version 1.0 
  * @date 2022
  * @author 	
  */
 ...
 #ifndef __FREEBMCFWSENSORSYSTEMBOARDVOLTAGEEVENTGENERATION_H__
 #define __FREEBMCFWSENSORSYSTEMBOARDVOLTAGEEVENTGENERATION_H__
 
 BMCFirmwareSensorThresholdEventGeneration_sT BMCFirmwareSensorSystemBoardVoltageEventGeneration[] = {
 ...
 #endif /* __BMCFWSENSORSYSTEMBOARDVOLTAGEEVENTGENERATION_H__ */
