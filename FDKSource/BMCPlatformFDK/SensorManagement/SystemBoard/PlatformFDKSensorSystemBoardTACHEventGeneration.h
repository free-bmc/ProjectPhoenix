/** 
  * @file BMCFWSensorSystemBoardTACHEventGeneration.h
  * @brief  BMC Firmware Sensor System Board TACH Event Generation Information 
  * @version 1.0 
  * @date 2022
  * @author 	
  */
 ...
 #ifndef __BMCFWSENSORSYSTEMBOARDTACHEVENTGENERATION_H__
 #define __BMCFWSENSORSYSTEMBOARDTACHEVENTGENERATION_H__
 
 PlatformFDKSensorThresholdEventGeneration_sT PlatformFDKSensorSystemBoardTACHEventGeneration[] = {
    ...
    */
    ...
    { 
        SYSTEM_BOARD_TACH_SENSOR_NUMBER_0, 
        {
            {   // Upper Non Recoverable Going High 
                ...
                BMCFW_PLATFORM_ONBOARD_0_COMPONENT_ID_FAN,              // Event Source
    ...
    { 
        ...
        {   // Upper Non Recoverable Going High 
            ...
            (A_SEL | A_PC | A_PD | A_AFB | A_FLS | A_MAN | A_AUTO), // Assertion
            (A_SEL | A_PC | A_PD | A_AFB | A_FLS | A_MAN | A_AUTO), // DeAssertion
            BMCFW_PLATFORM_ONBOARD_1_COMPONENT_ID_FAN,              // Event Source
            BMCFW_FW_SENSOR_MONITORING_COMPONENT_ID,                // Firmware Source
        },
 ...
 #endif /* __BMCFWSENSORSYSTEMBOARDTACHEVENTGENERATION_H__ */
